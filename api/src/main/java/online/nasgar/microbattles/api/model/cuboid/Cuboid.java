package online.nasgar.microbattles.api.model.cuboid;
...
public class Cuboid implements Iterable<Block>, Cloneable, ConfigurationSerializable {
  ...
  @JsonIgnore
  protected int z2;
  protected CoordinatePoint upperBound;
  protected CoordinatePoint lowerBound;
   ...
   *
   * @param lowerBound - One of the corners
   * @param upperBound - The other corner
   */
  @ConstructorProperties({
    "lowerBound",
    "upperBound"
  })
  public Cuboid(CoordinatePoint lowerBound, CoordinatePoint upperBound) {
    if (!lowerBound.getWorld().equals(upperBound.getWorld()))
      throw new IllegalArgumentException("Locations must be on the same world");
    this.worldName = lowerBound.getWorld();
    this.x1 = (int) Math.min(lowerBound.getX(), upperBound.getX());
    this.y1 = (int) Math.min(lowerBound.getY(), upperBound.getY());
    this.z1 = (int) Math.min(lowerBound.getZ(), upperBound.getZ());
    this.x2 = (int) Math.max(lowerBound.getX(), upperBound.getX());
    this.y2 = (int) Math.max(lowerBound.getY(), upperBound.getY());
    this.z2 = (int) Math.max(lowerBound.getZ(), upperBound.getZ());
   ...
   *
   * @param lowerBound location of the Cuboid
   */
  public Cuboid(CoordinatePoint lowerBound) {
    this(lowerBound, lowerBound);
  }
  ...
  public CoordinatePoint getLowerBound() {
    return lowerBound;
  }

  public void setLowerBound(CoordinatePoint lowerBound) {
    this.lowerBound = lowerBound;
  }
  ...
  public CoordinatePoint getUpperBound() {
    return upperBound;
  }

  public void setUpperBound(CoordinatePoint upperBound) {
    this.upperBound = upperBound;
  }
